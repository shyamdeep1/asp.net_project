...
namespace Job_Portal
{
    public partial class job_details : System.Web.UI.Page
    {
        ...
        private void LoadUserDetails()
        {
            ...
            getcon();
            da = new SqlDataAdapter("SELECT Email FROM Users WHERE UserID = '" + userId + "'", con);
            ds = new DataSet();
            da.Fill(ds);
        ...
        {
            getcon();
            da = new SqlDataAdapter("SELECT j.*, r.CompanyName FROM Jobs j INNER JOIN Recruiters r ON j.RecruiterID = r.RecruiterID WHERE j.JobID = '" + jobId + "'", con);
            ds = new DataSet();
            da.Fill(ds);
